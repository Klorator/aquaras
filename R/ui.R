    ...
    shiny::tabPanel("Well input", # Tab: Well input -----------------------------------
      ...
      htmltools::br(),
        ...
        shiny::column(width = 3,
          ...
          shiny::actionButton("well.update", "Update well",
            icon = shiny::icon(name = NULL, class = "far fa-save"), class = "btn-success")),
        shiny::column(width = 4) # End column (top row far right column)
      ...
      shiny::fluidRow( # Well info section
        ...
        shiny::column(width = 4, # Input: meta data
          ...
          shiny::actionButton("default.dateSign", "Set date & signature for all wells",
            icon = shiny::icon(name = NULL, class = "fas fa-pen-nib"))) # End column (Input: meta data)
      ...
      shiny::fluidRow(
        ...
        shiny::column(width = 3,
          ...
          shiny::actionButton("create.runlist", "Generate Runlist",
            icon = shiny::icon(name = NULL, class = "fas fa-hat-wizard"), class = "btn-success"),
          htmltools::br(),
          htmltools::br(),
